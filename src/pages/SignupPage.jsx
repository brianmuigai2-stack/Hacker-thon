...
const SignupPage = ({ onLogin }) => {
  ...
  const handleChange = (e) => {
    ...
    if (name === 'email') {
      if (value) {
        const emailValidation = validateEmailStrength(value);
  ...
  const handleSubmit = async (e) => {
    ...
    // Validate email
    const emailValidation = validateEmailStrength(formData.email);
    ...
    <div className="auth-page">
      <div className="auth-container">
        <div className="auth-card">
          ...
          <button onClick={handleGoogleSignUp} className="btn-google" disabled={googleLoading}>
            {googleLoading ? (
